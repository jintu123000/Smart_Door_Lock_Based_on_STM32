...
#define PORT_GPIO       GPIOB
//SDA
#define GPIO_CS         GPIO_Pin_12
//SCK
#define GPIO_SCK        GPIO_Pin_13
//MOSI
#define GPIO_MOSI       GPIO_Pin_14
//RST
#define GPIO_RST        GPIO_Pin_8
//MISO
#define GPIO_MISO       GPIO_Pin_15
...
#define   RC522_Reset_Enable()      GPIO_WriteBit(GPIOA, GPIO_RST,Bit_RESET)
#define   RC522_Reset_Disable()     GPIO_WriteBit(GPIOA, GPIO_RST,Bit_SET)
